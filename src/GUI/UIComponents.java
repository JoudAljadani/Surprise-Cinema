...
public class UIComponents {
    ...
    public static final Font FONT_TITLE = new Font("Arial", Font.BOLD, 22); //Title
    public static final Font FONT_SUBTITLE = new Font("Arial", Font.PLAIN, 16);//Subtitle or question
    ...
    public static void drawButton(Graphics2D g2, Rectangle r, String text, boolean pressed) {
        ...
        g2.fillRoundRect(r.x, r.y, r.width, r.height, BUTTON_RADIUS, BUTTON_RADIUS);
    ...
    //Back arrow
    public static void drawTextBackArrow(Graphics2D g2, Rectangle r, boolean pressed){
    ...
    public static void drawSelectableCard(Graphics2D g2, Rectangle r, String icon, String label, boolean selected) {
    ...
    public static void drawIconCard(Graphics2D g2, Rectangle r, String label, Image icon, boolean pressed){
        int radius = 20;
    ...
    //Title
    public static void drawTitle(Graphics2D g2, int panelWidth, int y){
